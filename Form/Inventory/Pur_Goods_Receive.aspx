    ...
    <br />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                &nbsp;&nbsp;
                <asp:Button ID="btnBrowse" runat="server" Text="Browse" CssClass="btn btn-secondary" Style="border-style: inset; width: 78px" OnClick="btnBrowse_Click" />
                &nbsp;&nbsp;
