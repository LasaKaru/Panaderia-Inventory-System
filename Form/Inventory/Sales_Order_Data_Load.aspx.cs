...
{
    public partial class Sales_Order_Data_Load : System.Web.UI.Page
    {
            ...
            using (var stream = new MemoryStream())
            {
                using (var writer = new PdfWriter(stream))
                {
                    using (var pdf = new PdfDocument(writer))
                    {
                        ...
                        Paragraph title1 = new Paragraph("Sales Order Data Report")
                            .SetTextAlignment(TextAlignment.CENTER)
                            .SetFontSize(9);
                        document.Add(title1);
                ...
                File.WriteAllBytes(Server.MapPath("~/Reports/SalesOrderDataReport.pdf"), stream.ToArray());
            }
        }

        protected void btnDownloadPDF_Click(object sender, EventArgs e)
        {
            string filePath = Server.MapPath("~/Reports/SalesOrderDataReport.pdf");
            ...
            if (file.Exists)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=SalesOrderDataReport.pdf");
