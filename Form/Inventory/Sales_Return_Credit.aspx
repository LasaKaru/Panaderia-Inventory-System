            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <label for="txtCustomer" class="auto-style400" style="background-color: #C0C0C0" width="120%"></label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <button for="txtInvoice" class="auto-style328" style="background-color: #C0C0C0">...</button>

                    </div>

                    <div class="col-sm-2">

                        <input type="text" id="txtInvoice" class="auto-style327">
