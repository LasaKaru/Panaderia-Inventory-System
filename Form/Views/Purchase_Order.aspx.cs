    ...
    public partial class Purchase_Order : System.Web.UI.Page
    {
...

        {
            using (var stream = new MemoryStream())
            {
                ...
                File.WriteAllBytes(Server.MapPath("~/Reports/Purchase_Order_Report.pdf"), stream.ToArray());
            }
        }

        protected void btnDownloadPDF_Click(object sender, EventArgs e)
        {
            string filePath = Server.MapPath("~/Reports/Purchase_Order_Report.pdf");
            ...
            if (file.Exists)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Purchase_Order_Report.pdf");
