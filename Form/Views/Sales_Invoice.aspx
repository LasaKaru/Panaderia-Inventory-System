<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales_Invoice.aspx.cs" Inherits="Panaderia.Form.Views.Sales_Invoice" %>
...
<br />
    ...
    <div class="row">
        ...
        <div>
                    <asp:Button ID="Button1" runat="server" Text="Load Sales Invoice" OnClick="btnGenerateReport_Click" CssClass="btn btn-primary" />
            <!--
