<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trial_Balance.aspx.cs" Inherits="Panaderia.Form.Accounts.Trial_Balance" %>
...
<br />
    ...
    <div class="row">
        ...
        <div>
                    <asp:Button ID="Button1" runat="server" Text="Load" OnClick="btnLoadReport_Click" CssClass="btn btn-primary" width="100px"/> 
        ...
        <div class="row">
           ...
           <tbody>
                 ...
                 <div class="form-group row">
                    ...
                    <label for="txttotal" class="col-sm-2 col-form-label" style="border-width: thin; background-color: #FFFFFF": width:15px></label>
                    ...
                    <div class="col-sm-50">                       
                     ...
                     <label for="txttotal" class="col-sm-5 col-form-label" style="border-width: thin; background-color: #FFFFFF": width:15px></label>
    ...
    <div class="row">
        <div class="col-md-6"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          
            &nbsp;&nbsp; <button type="button" id="btnBrowse" class="btn btn-primary" style="border-style: inset; width: 100px">Print</button>
