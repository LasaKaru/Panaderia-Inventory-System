<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proffit_and_Loss_Account.aspx.cs" Inherits="Panaderia.Form.Accounts.Proffit___Loss_Account" %>
...
<br />
    ...
    <div class="row">
        ...
        <div>
                    ...
                    <asp:Button ID="Button2" runat="server" Text="Print" OnClick="btnLoadReport_Click" CssClass="btn btn-primary" width="100px"/>
