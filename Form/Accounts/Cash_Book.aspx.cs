...
{
    public partial class Cash_Books : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Check if GridView2 has data
            if (GridView2.Rows.Count > 0)
            {
                // GridView2 has data, set the class
                divColSm50.Attributes["class"] = "col-sm-50";
            }
            else
            {
                // GridView2 has no data, you can choose to hide or set another class
                divColSm50.Attributes["class"] = "hidden-class"; // Replace "hidden-class" with the class you want to use when there is no data
            }
