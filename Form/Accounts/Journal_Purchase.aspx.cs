...
{
    public partial class Journal_Purchase : System.Web.UI.Page
    {
            ...
            using (var stream = new MemoryStream())
            {
                using (var writer = new PdfWriter(stream))
                {
                    using (var pdf = new PdfDocument(writer))
                    {
                        ...
                        Paragraph title1 = new Paragraph("Purchase Journal")
                            .SetTextAlignment(TextAlignment.CENTER)
                            .SetFontSize(9);
                        document.Add(title1);
                ...
                File.WriteAllBytes(Server.MapPath("~/Reports/Purchase Journal.pdf"), stream.ToArray());
            }
        }

        protected void btnDownloadPDF_Click(object sender, EventArgs e)
        {
            string filePath = Server.MapPath("~/Reports/Purchase Journal.pdf");
            ...
            if (file.Exists)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Purchase Journal.pdf");
        ...
        private void GenerateXLSMReport(DataTable dataTable)
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                // Example:
                worksheet.Cell("A1").Value = "Purchase Journal";
                ...
                workbook.SaveAs(Server.MapPath("~/Reports/Purchase Journal.xlsm"));
            }
        }
