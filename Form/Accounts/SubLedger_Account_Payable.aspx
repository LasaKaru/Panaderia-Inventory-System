<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubLedger_Account_Payable.aspx.cs" Inherits="Panaderia.Form.Accounts.SubLedger_Account_Payable" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sub Ledger Account Payable </title>
    <meta charset="UTF-8"/>
...
<br />
    ...
    <div class="row">
        ...
        <div>
            ...
            <asp:Button ID="Button6" runat="server" Text="Exit / Return " OnClick="btnGenerateReport_Click" CssClass="btn btn-primary" OnClientClick="return showDownloadButton();"/>
                </div>
