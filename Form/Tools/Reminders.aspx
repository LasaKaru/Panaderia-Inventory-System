<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reminders.aspx.cs" Inherits="Panaderia.Form.Tools.Reminders" %>
...
<body>
    ...
    <div class="row">
    <div class="col-md-6">
        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary" Style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;"/>
        &nbsp;&nbsp; <asp:Button ID="btnBrowse" runat="server" Text="Browse" CssClass="btn btn-danger" Style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;"/>
        &nbsp;&nbsp; <asp:Button ID="btnFind" runat="server" Text="Find" CssClass="btn btn-danger" Style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;"/>
        &nbsp;&nbsp; <asp:Button ID="btnExit" runat="server" Text="Exit" CssClass="btn btn-danger" Style="border-color: #000000; border-style: inset; width: 100px; background-color: #3333ffcc;"/>
    </div>
</div>
