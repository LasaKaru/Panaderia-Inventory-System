...
<!--Ganeesha Put Your Code Here-->
    ...
    <div class="col-sm-8">
        <input type="text" id="txtUserID" class="form-control">
                ...
                <div class="form-group row">
    <label for="txtUserName" class="col-sm-4 col-form-label">Supplier Name</label>
    <div class="col-sm-8">
...
<br />
                ...
                <div class="form-group row">
    <label for="txtcontactp1" class="col-sm-4 col-form-label">Contact Person 2</label>
    <div class="col-sm-8">
        <input type="text" id="txtcontactp2" class="form-control">
    </div>
</div>
    ...
    <label for="txtcontactdetail" class="col-sm-4 col-form-label">Contact Details</label>
    <div class="col-sm-8">
        <input type="text" id="txtcontactdetail2" class="form-control">
    </div>
</div>
<br />

                <div class="form-group row">
    <label for="txtcontactp1" class="col-sm-4 col-form-label">Contact Person 3</label>
    <div class="col-sm-8">
        <input type="text" id="txtcontactp3" class="form-control">
    </div>
</div>
    ...
    <label for="txtcontactdetail" class="col-sm-4 col-form-label">Contact Details</label>
    <div class="col-sm-8">
        <input type="text" id="txtcontactdetail3" class="form-control">
    </div>
</div>
<br />
    ...
    <div class="col-sm-8">
        <input type="text" id="txtcreditperiod" class="form-control">
                ...
                <div class="form-group row">
    <label for="txtleadtime" class="col-sm-4 col-form-label">Lead Time</label>
    <div class="col-sm-8">
        <input type="text" id="txtleadtime" class="form-control">
    </div>
</div>
                ...
                <div class="form-group row">
    <label for="txtUserGroup" class="col-sm-4 col-form-label">Supplier type</label>
    <div class="col-sm-2">
...
<br />
                ...
                <div class="form-group row">
    <label for="txtbank&branch" class="col-sm-4 col-form-label">Bank & Branch</label>
    <div class="col-sm-8">
        <input type="text" id="txtbank&branch" class="form-control">
    </div>
</div>
    ...
    <div class="col-sm-8">
        <input type="text" id="txtaccNo" class="form-control">
                ...
                <div class="form-group row">
    <label for="txtaccNo" class="col-sm-4 col-form-label">Name on Account</label>
    <div class="col-sm-8">
        <input type="text" id="txtaccNo" class="form-control">
    </div>
</div>
    ...
    <div class="col-sm-2">
        <input type="text" id="txtledgeraccount" class="auto-style326" readonly>
    </div>
    <div class="col-sm-6">
        <select id="ddlledgeraccount" class="auto-style327" onchange="updateledgeraccountText()">
            <option value="1">Account Payable</option>
            <option value="2">Electricity Payable</option>
            <option value="3">Water Bill Payable</option>
            <option value="4">Notes Payable</option>
            <option value="5">Salaries Payable</option>
            <option value="6">Rent Payable</option>
            <option value="7">Interest Payable</option>
            <option value="8">Uneaened Revenue</option>
        </select>
    </div>
</div>    
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                &nbsp;&nbsp;
                <button type="button" id="btnBrowse" class="btn btn-secondary" style="border-style: inset; width: 100px">Browse</button>
                &nbsp;&nbsp;
