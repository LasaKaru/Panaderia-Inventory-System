...
{
    public partial class SetOFF_Payment : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
           ...
           ([CompanyID],[IPS_Date],[Branch],[TxnType],[Number],[User],[Supplier_Vendor],[sup_name],[Amount],[GLAccount]
           ,[SupplierReferance],[Reason],[Details])
     VALUES
    (@CompanyID, @IPS_Date, @Branch, @TxnType, @Number, @User, @Supplier_Vendor, @sup_name, @Amount,@GLAccount,@SupplierReferance,@Reason,@Details)";
                ...
                using (SqlCommand cmd = new SqlCommand(insertQuery, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Supplier_Vendor", txtvendor.Text);
                    cmd.Parameters.AddWithValue("@sup_name", txtsup.Text);
                    cmd.Parameters.AddWithValue("@Amount", txtamount.Text);
                    cmd.Parameters.AddWithValue("@GLAccount", txtGLacc.Text);
