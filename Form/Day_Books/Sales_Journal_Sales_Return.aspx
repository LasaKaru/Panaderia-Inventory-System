...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="TxnType" runat="server" CssClass="input-field" ReadOnly="True" OnTextChanged="TxnType_TextChanged">SALRETURN</asp:TextBox></div>
            ...
            <div class="col-md-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="auto-style401">
                        <asp:TextBox ID="txtSourceAcc" runat="server" CssClass="auto-style327" OnTextChanged="txtSourceAcc_TextChanged">1027</asp:TextBox>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="txtreferance" runat="server" CssClass="form-control" OnTextChanged="txtreferance_TextChanged"></asp:TextBox>
                    </div>
