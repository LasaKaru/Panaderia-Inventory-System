<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBook_Payment.aspx.cs" Inherits="Panaderia.Form.Day_Books.CashBook_Payment" %>
...
<!--Ganeesha Put Your Code Here-->
   ...
   <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label type="label" id="cashbook" class="bcol-sm-4 col-form-label" style="border-style: inset; width: 106px; background-color: #999999;">Payment</label>
