<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetOFF_Receipt.aspx.cs" Inherits="Panaderia.Form.Day_Books.SetOFF_Receipt" %>
...
<br />
   ...
   <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="TxnType" runat="server" CssClass="input-field" ReadOnly="True">FRECEIPT</asp:TextBox></div>
...
<div class="form-group row">
                    ...
                    <label for="txtSupplierVendor" class="col-sm-4 col-form-label">Sub Ledger Account</label>
                    ...
                    <div class="col-sm-2" style="background-color: #FFFFFF">
                        ...
                        <lable for="txtsupplierVendor" class="auto-style328" style="background-color: #FFFFFF">AR</lable>

                    </div>

                    <div class="col-sm-2">

                        <asp:TextBox ID="txtsubledger" runat="server" CssClass="auto-style327"></asp:TextBox>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <label for="txtPONumber" class="col-sm-4 col-form-label">Ledger Account</label>

                    <div class="col-sm-2">

                        <label for="txtPONumber" class="auto-style328" style="background-color: #FFFFFF">CR</label>
        ...
        <div class="form-group row">
            ...
            <div id="Panel1" style="height: 345px;  width:925px; background-color: #99ccff59;">
                ...
                <table id="GridView2" class="auto-style401">
