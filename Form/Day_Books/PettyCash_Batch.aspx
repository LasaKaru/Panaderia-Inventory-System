<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PettyCash_Batch.aspx.cs" Inherits="Panaderia.Form.Day_Books.PettyCash_Batch" %>
...
<head runat="server"> 
    ...
    <link href="../../Content/Daybooks/SetOff.css" rel="stylesheet" media="screen" />
...
<br />
  ...
  <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><input name="TxnType" type="text" id="TxnType" class="input-field" placeholder="PCBA"/></div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <label for="txtSupplierVendor" class="col-sm-4 col-form-label">Float / Account </label>

                    <div class="col-sm-8">

                        <select id="DropDownList1" class="form-control" style="border-color: #C0C0C0; height: 32px; width: 174px;">

                            <option>Petty Cash Float 01</option>

                            <option>Petty Cash Float 02</option>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <button type="button" id="btnSave" class="btn btn-primary" style="border-color: #999999; border-style: inset; width: 115px; background-color: #337ab7;">Load</button>

                </div>

                <div class="form-group row">

                    <label for="txtInvoiceNo" class="col-sm-4 col-form-label">Details</label>
        ...
        <div class="form-group row">
            ...
            <div id="Panel1" style="background-color: #faeeee;" class="auto-style403">
                ...
                <table id="GridView1" class="auto-style401">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="auto-style402">Ref 3</th>
    ...
    <div class="col-sm-50">
        <input type="text" id="txttotal" class="auto-style326" style="width:116px"  readonly>
    </div>
</div>
