<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase_Journal_GRN_Posting.aspx.cs" Inherits="Panaderia.Form.Day_Books.Purchase_Journal_GRN_Posting" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GRN Posting </title>
    <meta charset="UTF-8"/>
...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><input name="TxnType" type="text" id="TxnType" class="input-field" placeholder="RGRN"/></div>
        ...
        <div class="row">
           ...
           <tbody>
                 ...
                 <div class="form-group row">
                    ...
                    <label for="txttotal" class="col-sm-3 col-form-label" style="border-width: thin; background-color: #FFFFFF": width:15px></label>

                    <div class="col-sm-50">                       

                        <input type="Label" id="txttotal" class="auto-style326" style="width:100px"  readonly>
