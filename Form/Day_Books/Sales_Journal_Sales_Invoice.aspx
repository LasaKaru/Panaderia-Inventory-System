<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales_Journal_Sales_Invoice.aspx.cs" Inherits="Panaderia.Form.Day_Books.Sales_Journal_Sales_Invoice" %>
...
<head runat="server">
    ...
    <!--Common CSS File -->
    <link href="../../Content/Daybooks/ServivceJournal.css" rel="stylesheet" />
...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><input name="TxnType" type="text" id="TxnType" class="input-field" placeholder="Sales Invoice"></></div>
...
<!--Ganeesha Put Your Code Here-->
   ...
   <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label type="label" id="cashbook" class="bcol-sm-4 col-form-label" style="border-style: inset; width: 106px; background-color: #999999;">Purchase</label>
