<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales_Journal_Sales_Posting.aspx.cs" Inherits="Panaderia.Form.Day_Books.Sales_Journal_Sales_Posting" %>
...
<head runat="server">
    ...
    <link href="../../Content/Daybooks/SalesJournal.css" rel="stylesheet" />
...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><input name="TxnType" type="text" id="TxnType" class="input-field" Placeholder="SINV"/></div>
