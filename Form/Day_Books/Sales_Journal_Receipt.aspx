<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales_Journal_Receipt.aspx.cs" Inherits="Panaderia.Form.Day_Books.Sales_Journal_Receipt" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
        <title>Sales Journal Receipt</title>
    <meta charset="UTF-8"/>
...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="TxnType" runat="server" CssClass="input-field" ReadOnly="True" OnTextChanged="TxnType_TextChanged">RECEIPT</asp:TextBox></div>
            ...
            <div class="col-md-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="auto-style401">
                        <asp:TextBox ID="txtSourceAcc" runat="server" CssClass="auto-style327" OnTextChanged="txtSourceAcc_TextChanged">1002</asp:TextBox>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="txtamount" runat="server" CssClass="form-control" OnTextChanged="txtamount_TextChanged">0.00</asp:TextBox>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="txtAdjustment" runat="server" CssClass="form-control" OnTextChanged="txtAdjustment_TextChanged">0.00</asp:TextBox>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="txtNetamount" runat="server" CssClass="form-control">0.00</asp:TextBox>
                    </div>
