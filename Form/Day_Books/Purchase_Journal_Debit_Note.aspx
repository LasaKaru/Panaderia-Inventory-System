...
<br />
 ...
 <div class="table-row">
    ...
    <div class="table-cell" style="background-color: #eb1f10; width: 300px;"><asp:TextBox ID="TxnType" runat="server" CssClass="input-field" ReadOnly="True">DEBITNOTE</asp:TextBox></div>
        ...
        <div class="row ">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <asp:TextBox ID="txtSourceAcc" runat="server" CssClass="auto-style327" OnTextChanged="txtSourceAcc_TextChanged">1033</asp:TextBox>
                    </div>
