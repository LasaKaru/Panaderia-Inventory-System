<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Month_End.aspx.cs" Inherits="Panaderia.Form.Day_Books.Month_End" %>
...
<head runat="server">
    ...
    <!--Common CSS File -->
    <link rel="stylesheet" href="../../Content/Daybooks/Journalentry.css" media="screen" />
...
<br />
  ...
  <div class="table-row">
      ...
      <div class="table-cell header" style="background-color: #eb1f10; width: 36px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Company</div>

    <div class="table-cell" style="background-color: #eb1f10; width: 65px;"><input name="Company" type="text" id="company" class="input-field" /></div>   

    <div class="table-cell header" style="background-color: #eb1f10; width: 36px; font-weight: bold; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; User</div>

    <div class="table-cell" style="background-color: #eb1f10; width: 65px;"><input name="user" type="text" id="user" class="input-field" /></div>
