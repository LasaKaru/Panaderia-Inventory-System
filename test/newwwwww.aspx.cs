        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    // Iterate through each row in the DataTable and save to the database
                    foreach (DataRow row in dt.Rows)
                    {
                        string insertQuery = "INSERT INTO purchase_order_footer (ItemCode, Description, Price, PSize, Packs, Nos, Discount, Amount, GrandTotal) " +
                ...
                // Optionally, you may want to display a success message or perform other actions after saving
