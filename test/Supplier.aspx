<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier.aspx.cs" Inherits="Panaderia.test.Supplier" %>
    ...
    <body>
        ...
        <form id="form1" runat="server">
            ...
            <div class="auto-style32">
                ...
                <div class="table-row">
                    ...
                    <div class="table-cell" style="background-color: #eb1f10; width: 300px;">
                        <asp:TextBox ID="SerialNumber" runat="server" CssClass="input-field"></asp:TextBox></div>
            ...
            <script>
                ...
                var txtcountrynput = document.getElementById('txtcountry');
                ...
                function selectRow(row, rowData) {
                    ...
                    txtcountrynput.value = cells[5].textContent;
            ...
            <script>
                ...
                function updateUserGroupText() {
                    ...
                    var dropdown = document.getElementById("ddlsupType");

                    var selectedText = dropdown.options[dropdown.selectedIndex].text;

                    document.getElementById("txtsupType").value = selectedText;
